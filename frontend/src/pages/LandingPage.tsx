    ...
    <div className="min-h-screen bg-[#0f0f0f] text-white">
      ...
      <section className="relative flex min-h-[100svh] flex-col overflow-hidden border-b border-[#2a2a2a]">
        ...
        <div className="relative z-10 mx-auto flex min-h-screen w-full max-w-7xl flex-1 flex-col items-center justify-center px-4 sm:px-6 lg:px-8 pb-16 pt-32 text-center">
          ...
          <p className="mt-5 max-w-3xl text-sm text-white/70 sm:text-base md:text-lg">
          ...
          <div className="mt-8 flex flex-col items-stretch justify-center gap-3 sm:flex-row sm:items-center">
            ...
            <Link
              to="/pyqs"
              className="inline-flex items-center justify-center rounded-xl border border-white/25 bg-transparent px-4 py-3 text-sm font-semibold text-white transition-colors hover:border-white/45 hover:bg-white/5 sm:px-6"
            >
              Browse PYQs
            </Link>
          </div>
      ...
      <section className="border-b border-[#2a2a2a] bg-[#111111] py-6">
        <div className="mx-auto flex max-w-7xl flex-col items-center gap-3 px-4 sm:px-6 lg:px-8 text-center">
      ...
      <section className="w-full border-b border-[#2a2a2a] bg-[#111111] py-12 sm:py-16">
      ...
      <section className="py-12 sm:py-16 md:py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="rounded-3xl border border-[#6366f1]/30 bg-gradient-to-r from-[#4f46e5] via-[#6366f1] to-[#8b5cf6] p-6 text-center shadow-[0_30px_80px_-40px_rgba(99,102,241,0.9)] sm:p-10 md:p-14">
      ...
      <footer className="border-t border-[#2a2a2a] bg-[#0f0f0f] py-10">
        <div className="mx-auto flex max-w-7xl flex-col gap-5 px-4 sm:px-6 lg:px-8 md:flex-row md:items-center md:justify-between">
          <div>
